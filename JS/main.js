...
p1.addEventListener('mouseover', function(){
    ...
    projectPhoto.src = './resources/images/project1_photo.png';
});
...
p2.addEventListener('mouseover', function(){
    projectPhoto.style.display = 'block';
    projectPhoto.src = './resources/images/project2_photo.png';
});
...
p3.addEventListener('mouseover', function(){
    projectPhoto.style.display = 'block';
    projectPhoto.src = './resources/images/project3_photo.png';
});
...
p4.addEventListener('mouseover', function(){
    projectPhoto.style.display = 'block';
    projectPhoto.src = './resources/images/project4_photo.png';
});
